...
// export const HOST_USER_SERVICE = 'http://localhost:9091/';
export const HOST_USER_SERVICE = 'http://131.130.37.24:9091/';

export const HOST_MODEL_REPO_SERVICE = 'http://131.130.37.24:9092/';
// export const HOST_MODEL_REPO_SERVICE = 'http://localhost:9092/';


export const HOST_NEURAL_NETWORK = 'http://131.130.37.26:9094/';
